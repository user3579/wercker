...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "wercker-meetup-golang"
   config.vm.box_url = "file://./wercker-meetup-golang.box"
  ...
  config.vm.synced_folder "D:\\gd\\Projects\\wercker\\oracledeveloper-apac-wercker", "/home/vagrant/workspace/oracledeveloper-apac-wercker"
